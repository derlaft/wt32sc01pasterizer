 ...
 * Size: 40 px
 * Bpp: 4
 * Opts: --bpp 4 --size 40 --font /Users/user/past/assets/icomoon.ttf -o /Users/user/past/assets/ui_font_symbols.c --format lvgl --symbols ABCDEF --no-compress --no-prefilter
 ******************************************************************************/
