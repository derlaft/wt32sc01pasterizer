...
lv_obj_set_flex_flow(ui_MainControlScreen,LV_FLEX_FLOW_COLUMN);
lv_obj_set_flex_align(ui_MainControlScreen, LV_FLEX_ALIGN_SPACE_AROUND, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_START);
...
ui_RegisterPanel = lv_label_create(ui_MainControlScreen);
...
lv_obj_set_style_bg_color(ui_Dec, lv_color_hex(0x007B7B), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_bg_color(ui_Inc, lv_color_hex(0x007B7B), LV_PART_MAIN | LV_STATE_DEFAULT );
...
ui_RegisterPanel1 = lv_label_create(ui_MainControlScreen);
...
lv_obj_set_style_bg_color(ui_Dec1, lv_color_hex(0x007B7B), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_bg_color(ui_Inc1, lv_color_hex(0x007B7B), LV_PART_MAIN | LV_STATE_DEFAULT );
...
ui_Label3 = lv_label_create(ui_MainControlScreen);
lv_obj_set_width( ui_Label3, lv_pct(100));
lv_obj_set_height( ui_Label3, lv_pct(15));
lv_obj_set_align( ui_Label3, LV_ALIGN_CENTER );
lv_obj_set_flex_flow(ui_Label3,LV_FLEX_FLOW_ROW);
lv_obj_set_flex_align(ui_Label3, LV_FLEX_ALIGN_SPACE_AROUND, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_SPACE_BETWEEN);
lv_label_set_text(ui_Label3,"");

ui_ReadButton1 = lv_btn_create(ui_Label3);
lv_obj_set_width( ui_ReadButton1, lv_pct(40));
lv_obj_set_height( ui_ReadButton1, LV_SIZE_CONTENT);   /// 25
...
lv_obj_set_style_bg_color(ui_ReadButton1, lv_color_hex(0x007B7B), LV_PART_MAIN | LV_STATE_DEFAULT );
...
ui_WriteButton = lv_btn_create(ui_Label3);
...
lv_obj_set_style_bg_color(ui_WriteButton, lv_color_hex(0x007B7B), LV_PART_MAIN | LV_STATE_DEFAULT );
